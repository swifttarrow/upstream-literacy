...
- [x] Flag missing fields during preview and ingestion (district_size, enrollment, grade_bands, source_timestamp)
...
- District with missing recommended fields shows Warning; district missing name shows Blocked; preview and job reflect status
