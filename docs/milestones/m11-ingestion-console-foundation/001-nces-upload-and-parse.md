...
- [x] Build LEAID→(LAT, LON, LOCALE) map from EDGE; join when creating district_candidates from CCD rows; derive locale_code, locale_type, locale_subtype, locale_size, district_size from LOCALE
