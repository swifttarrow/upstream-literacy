...
- [x] Table columns: district name, state, NCES identifier, completeness score, missing data indicator, last source refresh
...
- PRD §§10.2, 10.3: each row shows name, state, NCES id, completeness score, missing indicator
